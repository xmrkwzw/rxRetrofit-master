package com.xmjj.jujianglibrary.http.downlaod;
...
import com.xmjj.jujianglibrary.http.downlaod.DownLoadListener.DownloadInterceptor;
import com.xmjj.jujianglibrary.subscriber.ProgressDownSubscriber;
    ...
    public void startDown(final DownInfo info) {
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .baseUrl(StringUtil.getBasUrl(info.getUrl()))
                    .build();
